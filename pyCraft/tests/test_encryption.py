...
KEY_LOCATION = os.path.join(os.path.dirname(os.path.realpath(__file__)), "encryption")
...
class Encryption(unittest.TestCase):
    ...
    def test_generate_hash(self):
        ...
        self.assertEquals("1f142e737a84a974a5f2a22f6174a78d80fd97f5", verification_hash)
...
class EncryptedConnection(test_connection.ConnectTest):
    def test_connect(self):
        self._test_connect(private_key=private_key, public_key_bytes=public_key)
...
class EncryptedCompressedConnection(
    EncryptedConnection, test_connection.ConnectCompressionLowTest
):
    pass


# Regression test for <https://github.com/ammaraskar/pyCraft/issues/109>.
class EncryptedCompressedReconnect(
    test_connection.ReconnectTest, EncryptedCompressedConnection
):
    pass
